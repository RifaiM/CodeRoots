        ...
        "sections": [
            {
                ...
                "content": "\n                <p>Every website you visit is built from 3 team players working in harmony. Toggle the checkboxes below to see what happens when you turn one off:</p>\n                \n                <div class=\"concept-interactive-container\" id=\"jsTriadWidget\">\n                    <div class=\"triad-toggle-bar\">\n                        <button type=\"button\" class=\"triad-toggle-btn active\" id=\"btnToggleHtml\" aria-pressed=\"true\">\n                            <span class=\"triad-btn-icon\">🧱</span>\n                            <span class=\"triad-btn-label\">1. HTML (Bones &amp; Structure)</span>\n                            <span class=\"triad-btn-status\">ON</span>\n                        </button>\n                        <button type=\"button\" class=\"triad-toggle-btn active\" id=\"btnToggleCss\" aria-pressed=\"true\">\n                            <span class=\"triad-btn-icon\">🎨</span>\n                            <span class=\"triad-btn-label\">2. CSS (Clothes &amp; Styling)</span>\n                            <span class=\"triad-btn-status\">ON</span>\n                        </button>\n                        <button type=\"button\" class=\"triad-toggle-btn active\" id=\"btnToggleJs\" aria-pressed=\"true\">\n                            <span class=\"triad-btn-icon\">⚡</span>\n                            <span class=\"triad-btn-label\">3. JavaScript (Brain &amp; Action)</span>\n                            <span class=\"triad-btn-status\">ON</span>\n                        </button>\n                    </div>\n                    <div class=\"triad-preview-screen\" id=\"triadPreviewScreen\">\n                        <!-- Hydrated by JS -->\n                    </div>\n                </div>\n            "
            },
            {
