...
class FinalChallenge {
    ...
    init() {
      ...
      this.checkCompletionStatus(); // ADD THIS LINE
    }
  
    // Add this to your FinalChallenge class constructor, after this.init()
    ...
    updateUIForCompletedLesson() {
      ...
      if (header && !header.querySelector('.completion-badge')) {
        ...
        // Add to existing challenge badge or create new container
  ...
  * {
  ...
  // Add this at the end of lesson15_remake.js
