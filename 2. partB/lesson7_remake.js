/**
 * Lesson 7 - CSS Box Model Interactive JavaScript
 * This file handles all interactive functionality for the CSS Box Model lesson
 */
...
function updateCursorPosition(textarea) {
  ...
  console.log('Cursor update:', {
    line,
    col,
    hasLineElement: !!currentLine,
    hasColElement: !!currentCol
  });
}
