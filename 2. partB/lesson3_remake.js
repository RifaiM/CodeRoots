/**
 * Lesson 3 - Links & Images Interactive Learning Module
 * This file handles the interactive demonstrations and exercises for HTML links and images
 */
...
document.getElementById('nextLessonBtn').addEventListener('click', function() {
  if (!this.disabled) {
    window.location.href = '/2. partB/lesson4_remake.html';
  }
});
