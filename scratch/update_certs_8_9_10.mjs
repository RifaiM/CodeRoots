...
cert8 = cert8.replace(/title="Level 8 Certificate:.*?"/, 'title="Level 8 Certificate: Async UI & Client Data Architecture | CodeRoots"');
...
cert9 = cert9.replace(/title="Level 9 Certificate:.*?"/, 'title="Level 9 Certificate: React Auth & Access Control | CodeRoots"');
...
cert10 = cert10.replace(/title="Level 10 Diploma:.*?"/, 'title="Level 10 Master Diploma: SaaS UI & Design Systems Architecture | CodeRoots"');
